...
CREATE TABLE animal_types (id INT NOT NULL AUTO_INCREMENT, animal_type VARCHAR, PRIMARY KEY (id));
...
CREATE TABLE animal_countries (id INT NOT NULL AUTO_INCREMENT, animal_country VARCHAR, PRIMARY KEY (id));
...
CREATE TABLE animal_fur_colors (id INT NOT NULL AUTO_INCREMENT, animal_fur_color VARCHAR, PRIMARY KEY (id));
...
CREATE TABLE pets (id INT NOT NULL AUTO_INCREMENT, name VARCHAR, code VARCHAR, animal_type_id INT, fur_color_id INT, country_id INT, PRIMARY KEY (id), FOREIGN KEY (animal_type_id) REFERENCES animal_types, FOREIGN KEY (country_id) REFERENCES animal_countries, FOREIGN KEY (fur_color_id) REFERENCES animal_fur_colors);
